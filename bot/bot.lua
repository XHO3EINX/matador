...
MaTaDoR_sudo = 389545921
GpsidSudo = 389545921
bot_id = 458366475
helper_id = 516695075
MaTaDoRch = '@AntiSpamCh'
MaTaDoRby = '@Alone_Member'
MaTaDoRbybot = '@AminPunisher_PvBot'
paypinglink = 'Nothing'
paypingname = 'NG' 
...
function create_config( )
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    sudo_users = {300131107,389545921,458366475}, -- در اینجا آیدی ربات api و cli  و سودو ها را وارد کنید
    admins = {},
    disabled_channels = {},
